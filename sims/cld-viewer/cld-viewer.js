...
async function loadExamplesList() {
    ...
    const examples = [
        { id: 'learning-flywheel-r1-cld', title: 'R1: The Learning Flywheel' },
        { id: 'learning-flywheel-r2-cld', title: 'R2: The Confidence Flywheel' },
        { id: 'learning-flywheel-b1-cld', title: 'B1: Knowledge Gap Regulator' },
        { id: 'learning-flywheel-full-cld', title: 'Full System: Learning Flywheel' }
    ];
    return examples;
}
