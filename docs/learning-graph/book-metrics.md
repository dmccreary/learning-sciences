...
|---|---------|-------|--------|-------|
| 1 | Concepts | 230 | Required | Concepts from learning graph |
| 2 | Chapters | 15 | Required | Chapter directories with index.md |
| 3 | MicroSims | 65 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 9 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 15 / 15 | Recommended | Chapters with a quiz.md (150 questions total) |
| 6 | Chapter References | 0 / 15 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 222 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 80 | Recommended | Questions in faq.md |
| 9 | Words | 234,532 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 60 | 60 | H4 headers starting with '#### Diagram:' |
| Equations | 1 | 0 | LaTeX expressions (inline and display) |
| Total Words | 234,532 | 133,590 | Words in markdown files |
| Links | 534 | 91 | Hyperlinks in markdown format |
| Equivalent Pages | 985 | 581 | Estimated pages (250 words/page + visuals) |
