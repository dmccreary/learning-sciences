[Content](../index.md){ .md-button } [Slides in Viewer](../../sims/slide-viewer/main.html?src=../../chapters/02-seven-domains/slides/){ .md-button .md-button--primary }
...
**R1 — Learning flywheel (forward chain):**
motivation → understanding → retention → application → expertise → motivation

**R2 — Evidence flywheel (measurement loop):**
outcomes → evidence → instructional design → quality → outcomes
