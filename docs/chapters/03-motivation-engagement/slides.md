...
**R1 — Competence flywheel (compounding):**
competence → effort → skill growth → competence

**R2 — Frustration brake (corrosive):**
frustration → avoidance → skill gap → worse difficulty match → more frustration
