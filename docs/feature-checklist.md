...
| MathJax equation rendering | :white_check_mark: | Low | Alternative math rendering with broader LaTeX support |
...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| MicroSims (interactive simulations) | :white_check_mark: | High | 1 browser-based apps for hands-on learning |
